...
Op \href{www.debian.org/distrib}{Debian website} kies je een klein installatie-image voor jouw architectuur (meestal amd64, soms nog i686).
...
%TODO firmware instructies
%TODO wireless instructies
%TODO APT-survival guide
\end{document}
